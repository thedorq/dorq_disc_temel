...
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('antidepresan', 'Antidepresan', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('temizlikbezi', 'Araç Temizlik Bezi', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('tyre', 'Tekerlek', 1, 0, 1);
...
INSERT INTO essentialmode.items (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('WEAPON_GRENADE', 'Grenade', 1, 0, 1);
