...
RegisterNUICallback('EnvanterYenile', function(data, cb)
    TriggerServerEvent('disc-inventoryhud:CombineStack', data)
    cb('OK')
end)
...
RegisterNetEvent('disc-inventoryhud:canta')
AddEventHandler('disc-inventoryhud:canta', function()
            ...
            ESX.TriggerServerCallback('disc-inventoryhud:getSecondaryInventory', function(data)
                SendNUIMessage(
                        { action = "setSecondInventoryItems",
                          ...
                          invOwner = data.invId,
                          invTier = data.invTier,
						  EsyaAgirlik = data.esyaninagirligi,
